...
public class GeometrySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GeometryPackage.LINK_GEOMETRY: {
				LinkGeometry linkGeometry = (LinkGeometry)theEObject;
				T result = caseLinkGeometry(linkGeometry);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Link Geometry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Link Geometry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLinkGeometry(LinkGeometry object) {
		return null;
	}
