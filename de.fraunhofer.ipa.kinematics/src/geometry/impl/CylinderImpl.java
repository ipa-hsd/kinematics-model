 ...
 * </p>
 * <ul>
 *   <li>{@link geometry.impl.CylinderImpl#getLength <em>Length</em>}</li>
...
public class CylinderImpl extends MinimalEObjectImpl.Container implements Cylinder {
	...
	public void setLength(double newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeometryPackage.CYLINDER__LENGTH, oldLength, length));
	}
