...
/**
 * This is the item provider adapter for a {@link composition.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CompositionPackage.Literals.COMPONENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_components_feature", "_UI_Component_type"),
				 CompositionPackage.Literals.COMPONENT__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CompositionPackage.Literals.COMPONENT__PARAMETERS);
			childrenFeatures.add(CompositionPackage.Literals.COMPONENT__LINKS);
			childrenFeatures.add(CompositionPackage.Literals.COMPONENT__JOINTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CompositionPackage.Literals.COMPONENT__PARAMETERS,
				 CompositionFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(CompositionPackage.Literals.COMPONENT__LINKS,
				 KinematicsFactory.eINSTANCE.createLink()));

		newChildDescriptors.add
			(createChildParameter
				(CompositionPackage.Literals.COMPONENT__JOINTS,
