...
/**
 * This is the item provider adapter for a {@link composition.ParameterInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterInstance_parameter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterInstance_parameter_feature", "_UI_ParameterInstance_type"),
				 CompositionPackage.Literals.PARAMETER_INSTANCE__PARAMETER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CompositionPackage.Literals.PARAMETER_INSTANCE__VALUE,
				 true,
				 false,
				 true,
				 null,
