...
/**
 * This is the item provider adapter for a {@link composition.LinkRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkRefItemProvider extends ParameterValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkRef_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkRef_ref_feature", "_UI_LinkRef_type"),
				 CompositionPackage.Literals.LINK_REF__REF,
				 true,
				 false,
				 true,
				 null,
