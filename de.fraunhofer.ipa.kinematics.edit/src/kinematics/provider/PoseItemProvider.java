...
/**
 * This is the item provider adapter for a {@link kinematics.Pose} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pose_x_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pose_x_feature", "_UI_Pose_type"),
				 KinematicsPackage.Literals.POSE__X,
				 true,
				 false,
				 false,
	...
	protected void addYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pose_y_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pose_y_feature", "_UI_Pose_type"),
				 KinematicsPackage.Literals.POSE__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addZPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pose_z_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pose_z_feature", "_UI_Pose_type"),
				 KinematicsPackage.Literals.POSE__Z,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addRollPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pose_roll_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pose_roll_feature", "_UI_Pose_type"),
				 KinematicsPackage.Literals.POSE__ROLL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addPitchPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pose_pitch_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pose_pitch_feature", "_UI_Pose_type"),
				 KinematicsPackage.Literals.POSE__PITCH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addYawPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pose_yaw_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pose_yaw_feature", "_UI_Pose_type"),
				 KinematicsPackage.Literals.POSE__YAW,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
