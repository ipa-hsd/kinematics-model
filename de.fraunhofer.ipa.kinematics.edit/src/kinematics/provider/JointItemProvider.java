...
public class JointItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KinematicsPackage.Literals.JOINT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLimitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Joint_limit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Joint_limit_feature", "_UI_Joint_type"),
				 KinematicsPackage.Literals.JOINT__LIMIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAxisPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Joint_axis_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Joint_axis_feature", "_UI_Joint_type"),
				 KinematicsPackage.Literals.JOINT__AXIS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KinematicsPackage.Literals.JOINT__PARENT);
			childrenFeatures.add(KinematicsPackage.Literals.JOINT__CHILD);
			childrenFeatures.add(KinematicsPackage.Literals.JOINT__ORIGIN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KinematicsPackage.Literals.JOINT__ORIGIN,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == KinematicsPackage.Literals.JOINT__PARENT ||
			childFeature == KinematicsPackage.Literals.JOINT__CHILD;
